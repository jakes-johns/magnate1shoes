...
shoes = [
    ...
    {'id': 2, 'name': 'Casual Sneakers', 'price': 60, 'description': 'Great for everyday wear', 'image': 'images/casual_sneakers.jpg'},
    {'id': 3, 'name': 'Formal Shoes', 'price': 120, 'description': 'Sleek and stylish for formal events', 'image': 'images/formal_shoes.jpg'},
